...
const socialLinks = [
  ...
  {
    href: 'https://www.instagram.com/noephilippe.dev/',
    ...
    <Main className={className} id={NavKeys.CONTACT}>
      ...
      <Row className="w-full justify-between items-end mt-10 md:mt-15">
        ...
        <Col className="w-full items-center  hidden md:flex">
          <CopyRight className="text-foreground/50 w-fit">{t('generics.copyright')}</CopyRight>
          <a
      ...
      <ColCenter className=" md:hidden">
        <CopyRight className="text-foreground/50 mt-10">{t('generics.copyright')}</CopyRight>
        <a
          href="/privacy-policy.html"
          target="_blank"
          rel="noopener noreferrer"
